...
function CreatePlayer() {
    ...
    const formSubmit = async (event) => {
        ...
        if (image !== "empty") {
            ...
            await API.post("/images/" + currentUser.uid +'/'+ data._id, image, {
                headers: {
    ...
    return (
    <section className='create-player-section'>
        <form onSubmit={formSubmit}>
            <div className='create-player-div'>
                <div>
                    <div>
                        <img alt="notfound" src="imgs/notfound_0_120.webp"></img>
                    </div>
                    <label>
                ...
                <div className='create-player-card'>
                    ...
                    <ul>
                        ...
                        <li>
                            <label>
                                Overall Rating:
                                <input type="number" required id='rating' name="rating" max="99" min="0"/>
                            </label>
                        </li>
                        <li>
                            <label>
                ...
                <div className='create-player-card'>
                    ...
                    <ul>
                        ...
                        <li>
                            <label>
                                Preferred Foot:
                                <select defaultValue='Right' id='select-preferred-foot'>
                        ...
                        <li>
                            <label>
                                Attacking Work Rate:
                                <select defaultValue='Medium' id='select-attacking-work-rate'>
                        ...
                        <li>
                            <label>
                                Defensive Work Rate:
                                <select defaultValue='Medium' id='select-defensive-work-rate'>
                                    <option value="Low">Low</option>
                                    <option value="Medium">Medium</option>
                                    <option value="High">High</option>
                                </select>
            ...
            <h4 className='create-player-h4'>Ability</h4>
            <div className='create-player-div'>
                <div className='create-player-ability-card'>
                    <h5>Attacking</h5>
                    <ul>
                        <li>
                            <label>
            ...
            <button className='create-player-submit-btn' type="submit">
                Submit
            </button>
        </form>
    </section>
